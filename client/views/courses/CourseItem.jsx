      ...
      <div className={classes} onDoubleClick={this.props.onCourseDoubleClick} onClick={this.props.onCourseClick}>
        <div className="astro_course_item_info">
          ...
          <section className="astro_course_item_bottom_info">
            <span className="astro_course_item_bottom_info_lessons"><img src="http://107.170.231.59/img/lessons.png"></img>{lessons.length}</span>
            <span className="astro_course_item_bottom_info_duration"><img src="http://107.170.231.59/img/clock.png"></img>{this.getCourseDuration(lessons)}&nbsp;min</span>
          </section>
        </div>
