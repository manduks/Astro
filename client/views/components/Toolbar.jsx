      ...
      <header className="astro_toolbar">
        <div className="astro_toolbar-inner">
            <div className="astro_toolbar_brand">
              {/* <span className="astro_toolbar_options_menu"><img src="http://107.170.231.59/img/menu.png"></img></span>*/}
              <span className="astro_toolbar_name" onClick={this.onAppIndex}>CODETLAN</span>
            </div>
            <span className="astro_toolbar_logo" onClick={this.onAppIndex}><img src="http://107.170.231.59/img/logo.png"></img></span>
            <div className="astro_toolbar_options">
              {/* <span className="astro_toolbar_options_search"><img src="http://107.170.231.59/img/search.png"></img></span>*/}
